...
public class WolfFangPotatoItem extends Item {
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, LivingEntity livingEntity) {
        // 只在物品启用并且是服务端时应用效果
        if (!level.isClientSide && livingEntity instanceof Player && WolfFangPotatoConfig.isWolfFangPotatoEnabled()) {
            // 应用狼群领袖效果
    ...
    public boolean isEdible() {
        // 根据配置决定是否可食用
        return super.isEdible() && WolfFangPotatoConfig.isWolfFangPotatoEnabled();
    }
} 